...
yaourt -S \
        ...
        # clojure build tool
        feh \
        #light weight previewer
        pulseaudio \
        # sound
        ponymix \
        # pulse sound cli  frontend
        openvpn \
        # vpn
        tree \
        # to visualize directory trees
        xclip \
        # access paste bugger on cli
        xorg-xbacklight
        # backlight cli frontend used by i3blocks
        acpi
        # used for getting battery charge in i3blocks
        xdotool
        # for i3blocks
        xorg-xprop
        # for i3blocks
        light-git
        # brightness ctrl for git
